Build me an academic paper search tool. Create domain plugins for three major academic databases — check if they have public APIs first before trying browser interception.
